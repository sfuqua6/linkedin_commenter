...
All API calls go directly from your browser to the AI provider. Nothing is proxied, logged, or sent anywhere else. Your API key lives in your browser's local storage.
